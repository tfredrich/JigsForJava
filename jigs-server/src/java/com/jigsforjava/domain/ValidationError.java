...
/**
 * An internationalizable domain semantic or syntactic validation error.
 * 
...
public class ValidationError
{
	...
	/**
	 * @param message A String to describe the error.
	 * @param parameters A HashMap of substitution parameters.  May be null.
	 */
