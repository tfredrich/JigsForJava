 ...
 */
public class PercentAttribute
extends AttributeModel<PercentAttribute>
{
	private Double contents;

	public PercentAttribute(String name)
	{
		super(name, "double");
		initialize(0.0d);
	}
	
	public PercentAttribute(String name, double value)
	{
		super(name, "double");
		initialize(value);
	}
	...
	public int compareTo(PercentAttribute attribute)
	{
		int comparison = 0;
		PercentAttribute toCompare = (PercentAttribute) attribute;
	...
	public String localize(I18n i18n)
	{
		...
		if (getValue() != null)
			result = i18n.localizeAsPercent(getValue().doubleValue());
