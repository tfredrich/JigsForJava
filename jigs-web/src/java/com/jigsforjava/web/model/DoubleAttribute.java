...
extends AttributeModel<DoubleAttribute>
{
	...
	public int compareTo(DoubleAttribute attribute)
	{
		int comparison = 0;
		DoubleAttribute toCompare = (DoubleAttribute) attribute;
	...
	public String localize(I18n i18n)
	{
		...
		if (getValue() != null)
			result = i18n.localize(getValue().doubleValue());
